...
<div class="card">
    <div class="card-header">
        <a name=""id=""class="btn btn-primary"href="crear.php"role="button">Agregar testimonios</a>   
    </div>
    <div class="card-body">
                ...
                <tbody>
                    <?php foreach($lista_testimonios as $key=>$value ){?>
                        <tr class="">
                            ...
                            <td>
                                <a name="" id="" class="btn btn-info" href="editar.php?txtID=<?php echo $value['ID'];?>" role="button">Editar testimonio</a>  
