        ...
        <div class="card-body">
            <form action="" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control"value="<?php echo $opinion;?>" name="opinion" id="opinion" aria-describedby="helpId" placeholder="Escriba aquí su opinión "/>
                </div>

                <div class="mb-3">
                    <label for="nombre" class="form-label">Nombre:</label>
                    <input type="text" class="form-control"value="<?php echo $nombre;?>" name="nombre" id="nombre" aria-describedby="helpId" placeholder="Escriba aquí su nombre "/>
                </div>
